      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_.75fr]">
        ...
        >
          <textarea
            ...
            className="min-h-[160px] w-full rounded-[1.8rem] border border-[#d8a5b8]/15 bg-[linear-gradient(180deg,#f8f3f7,#ece6ef)] p-5 text-sm leading-7 text-[#17141c] outline-none placeholder:text-[#8a7a8e]"
        ...
        <Panel title="Suggested tasks" subtitle="Examples of what Pulse can do">
          {[
            ...
            <button
              ...
              className="w-full rounded-3xl border border-white/8 bg-white/[0.04] p-4 text-left text-sm text-[#d8c8dc]/70 transition hover:bg-white/[0.08] hover:text-white"
            >
              {prompt}
            </button>
          ))}
