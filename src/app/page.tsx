        ...
        <aside className="hidden w-72 bg-[#24112f] px-5 py-6 text-purple-100 lg:block">
          ...
          <div className="mt-8 rounded-3xl border border-white/10 bg-white/5 p-4">
            ...
            <p className="mt-2 text-sm leading-6 text-purple-200">
              Tracking limited to approved client domains.
              Internal-only communication is excluded.
            </p>
          </div>
        </aside>
              ...
              <section className="grid gap-5 xl:grid-cols-[1.25fr_.75fr]">
                <div className="rounded-3xl bg-gradient-to-br from-[#24112f] via-[#4c1d5e] to-[#b43cc7] p-8 text-white shadow-sm">
                  ...
                  <h3 className="mt-5 max-w-3xl text-4xl font-semibold md:text-5xl">
                    Three accounts need action.
                    Everything else is stable.
                  </h3>

                  <p className="mt-5 max-w-2xl text-base leading-7 text-purple-100">
                    ClientPulse filters fragmented communication
                    across Outlook, Zoom, Teams, calls, and CRM
                    data into the few items leadership should
                    actually review.
                  </p>
          ...
          {activeTab === "Intelligence" && (
            <div className="mt-6 rounded-3xl border border-purple-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 text-slate-500">
                AI highlights the relationships and
          ...
          {activeTab === "Activity" && (
            <div className="mt-6 rounded-3xl border border-purple-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-6 space-y-4">
                ...
                <ActivityItem
                  icon={MessageSquare}
                  title="Client asked for timeline update"
                  client="Summit Insurance Group"
                  time="3 hours ago"
                />
              </div>
            ...
            <div className="mt-6 rounded-3xl border border-purple-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-3">
                {tasks.map((item) => (
                  <div
                    key={item.task}
                    className="rounded-3xl border border-purple-200 bg-[#faf5fb] p-4"
                  >
